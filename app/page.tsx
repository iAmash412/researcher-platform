...
export default function Home() {
  ...
  return (
    <>
      ...
      <main id="main">
        {/* ── Hero ── */}
        <section className="max-w-[1080px] mx-auto px-6 sm:px-8 pt-16 pb-14 sm:pt-28 sm:pb-20">
        ...
        <section className="border-y border-border">
          <div className="max-w-[1080px] mx-auto px-6 sm:px-8 py-8 grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            <div>
        ...
        <section className="max-w-[1080px] mx-auto px-6 sm:px-8 py-14 sm:py-20">
        ...
        <section className="bg-surface-alt border-y border-border">
          <div className="max-w-[1080px] mx-auto px-6 sm:px-8 py-14 sm:py-20">
            <p className="text-[12px] font-medium text-accent uppercase tracking-widest mb-2">
              Browse
            </p>
        ...
        {/* ── CTA ── */}
        <section className="max-w-[1080px] mx-auto px-6 sm:px-8 py-16 sm:py-24 text-center">
