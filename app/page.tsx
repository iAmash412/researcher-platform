...
export default function Home() {
  ...
  return (
    <>
      ...
      <main id="main">
        {/* ── Hero ── */}
        <section className="max-w-[1080px] mx-auto px-5 pt-20 pb-16 sm:pt-28 sm:pb-20">
          <p className="text-[12px] font-medium text-accent uppercase tracking-widest mb-4">
            Academic Directory
          </p>
          <h1 className="text-3xl sm:text-5xl font-bold tracking-tight leading-[1.1] mb-5 max-w-[600px]">
            Discover the minds shaping research
          </h1>
          <p className="text-[15px] sm:text-base text-text-secondary leading-relaxed max-w-[480px] mb-8">
        ...
        <section className="border-y border-border">
          <div className="max-w-[1080px] mx-auto px-5 py-8 grid grid-cols-2 sm:grid-cols-4 gap-6">
            <div>
        ...
        <section className="max-w-[1080px] mx-auto px-5 py-16 sm:py-20">
          <div className="flex items-end justify-between mb-8">
            ...
            <Link
              href="/researchers"
              className="text-[13px] text-muted hover:text-foreground transition-colors flex items-center gap-1"
            >
        ...
        <section className="bg-surface-alt border-y border-border">
          <div className="max-w-[1080px] mx-auto px-5 py-16 sm:py-20">
            <p className="text-[12px] font-medium text-accent uppercase tracking-widest mb-2">
              Browse
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
              {fields.map((field) => (
                ...
                >
                  <div>
                    <h3 className="text-[14px] font-medium text-foreground group-hover:text-accent transition-colors">
                      {field.name}
                    </h3>
        ...
        {/* ── CTA ── */}
        <section className="max-w-[1080px] mx-auto px-5 py-16 sm:py-24 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-4">
            Research should be visible
          </h2>
          <p className="text-[15px] text-text-secondary max-w-[420px] mx-auto mb-8 leading-relaxed">
