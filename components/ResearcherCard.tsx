    ...
    >
      <div className="flex items-start justify-between gap-3 mb-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-[11px] sm:text-[12px] text-text-secondary mt-1 truncate">
            {r.department}
          </p>
        </div>
      ...
      <div className="flex items-center gap-3 sm:gap-4 text-[11px] sm:text-[12px] text-muted mb-4 flex-wrap">
